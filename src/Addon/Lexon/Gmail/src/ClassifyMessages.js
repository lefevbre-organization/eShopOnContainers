(function (host, expose) {
 ...
 /**
  * The supported formats for the returned ClassifyMessages token.
  * @enum {string}
  */
 var TOKEN_FORMAT = {
...
//  }
 ...
 /**
  * Sets the format of the returned token. Default: ClassifyMessages.TOKEN_FORMAT.JSON.
  * @param {ClassifyMessages.TOKEN_FORMAT} tokenFormat The format of the returned token.
  * @return {Service_} This service, for chaining.
  */
...
//  };
 ...
 /**
  * Sets the ClassifyMessages grant_type to use when obtaining an access token. This does
  ...
  * the Authorization header required by the ClassifyMessages provider.
  * @param {string} grantType The ClassifyMessages grant_type value.
  * @return {Service_} This service, for chaining.
  */
...
//  };
 ...
 /**
  * Gets the authorization URL. The first step in getting an ClassifyMessages token is to
 ...
 /**
  * Completes the ClassifyMessages flow using the request data passed in to the callback
  * function.
...
// }
 ...
 Service_.prototype.getStorage = function() {
   ...
   if (!this.storage_) {
     var prefix = 'ClassifyMessages.' + this.serviceName_;
 ...
 }).call(this, this, "ClassifyMessages");