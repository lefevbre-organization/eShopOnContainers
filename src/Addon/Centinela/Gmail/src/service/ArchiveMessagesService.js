(function (host, expose) {
 ...
 /**
  * The supported formats for the returned ArchiveMessagesService token.
  * @enum {string}
  */
 var TOKEN_FORMAT = {
 ...
 /**
  * Creates a new message classification service with the name specified. It's usually best to
 ...
 /**
  * Creates a new message classification service.
  * @param {string} serviceName The name of the service.
  * @constructor
  */
  ...
  * this URL should be
  * https://accounts.google.com/o/classification/auth.
  ...
  * be https://accounts.google.com/o/classification/token.
 ...
 /**
  * Sets the format of the returned token. Default: ArchiveMessagesService.TOKEN_FORMAT.JSON.
  * @param {archiveMessagesService.TOKEN_FORMAT} tokenFormat The format of the returned token.
  * @return {Service_} This service, for chaining.
  */
...
//  };
 ...
 /**
  * Sets the ArchiveMessagesService grant_type to use when obtaining an access token. This does
  ...
  * the Authorization header required by the ArchiveMessagesService provider.
  * @param {string} grantType The ArchiveMessagesService grant_type value.
  * @return {Service_} This service, for chaining.
  */
...
//  };
 ...
 /**
  * Gets the authorization URL. The first step in getting an ArchiveMessagesService token is to
 ...
 /**
  * Completes the ArchiveMessagesService flow using the request data passed in to the callback
  * function.
 ...
 Service_.prototype.handleCallback = function(callbackRequest) {
  //  var login = callbackRequest.parameter.login;
  //  var password = callbackRequest.parameter.password;
...
// }
 ...
 Service_.prototype.getStorage = function() {
   ...
   if (!this.storage_) {
     var prefix = 'archiveMessagesService.' + this.serviceName_;
...
//  };
 ...
 }).call(this, this, "ArchiveMessagesService");