...
class GoTo extends Component {
    ...
    renderAddAccount(provider) {
        ...
        if (!accounts.some(account => (account.provider === provider))) {
            return (<li><ProviderInbox userId={userId} provider={provider} /></li>);
        } else {
            return null;
        }
    }
                        ...
                        <div className="col d-flex justify-content-center">
                            ...
                            <div className="row logo text-center">
                                    <div className="col">         
                                        ...
                                        <span className="mb-5">{i18n.t('page-goto.my-accounts')}</span>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
                                ...
                                <div className="row logo text-center">
                                    <div className="col">                                                                                        
                                        <span className="mb-5">{i18n.t('page-goto.add-account-mail')}</span>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
