...
export const FolderTypes = Object.freeze({
  INBOX: {serverName: 'INBOX', icon: 'move_to_inbox', position: 0},
  DRAFTS: {attribute: '\\Drafts', icon: 'border_color', position: 1},
  SENT: {attribute: '\\Sent', icon: 'send', position: 2},
  TRASH: {attribute: '\\Trash', icon: 'delete_outline', position: 3},
