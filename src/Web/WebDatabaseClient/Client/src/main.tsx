...
class Main extends Component<Props, State> {
  constructor(props: Props) {
    ...
    this.handlePutUserFromDatabaseConnector = this.handlePutUserFromDatabaseConnector.bind(
      this
    );
  ...
  componentDidMount() {
    ...
    window.addEventListener(
      'PutUserFromDatabaseConnector',
      this.handlePutUserFromDatabaseConnector
    );
  ...
  sendMessageGetUser() {
    console.log('Send Message -> Database - GetUserFromDatabaseConnector');
    window.dispatchEvent(new CustomEvent('GetUserFromDatabaseConnector'));
  }

  // TODO: Check this any type
  async handlePutUserFromDatabaseConnector(event: any) {
    console.log(
      'HandleEvent Client -> Database - PutUserFromDatabaseConnector'
    );
