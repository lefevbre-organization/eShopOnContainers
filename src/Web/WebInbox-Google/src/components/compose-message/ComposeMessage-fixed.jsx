                ...
                <div className="container-panel">
                    ...
                    <div id="Divfooter" className="compose-droppanel">
                        <DragDrop
                            ...
                            locale={{
                                strings: {
                                    dropHereOr: t('compose-message.drag-and-drop') + " " + t('compose-message.or') + " %{browse}" ,
                    ...
                    <div className="footer compose-footer">
                        ...
                        <Button className="marleft" title={t('compose-message.discard')} color="secondary" onClick={this.closeModal}>                          
