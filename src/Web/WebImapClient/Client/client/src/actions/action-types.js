export const ActionTypes = {
    ...
    APPLICATION_MESSAGE_REPLACE_IMAGE_BASE64: 'APPLICATION_MESSAGE_REPLACE_IMAGE_BASE64',
    APPLICATION_OUTBOX_SEND: 'APPLICATION_OUTBOX_SEND',
    APPLICATION_OUTBOX_UPDATE_PROGRESS: 'APPLICATION_OUTBOX_UPDATE_PROGRESS',
    APPLICATION_DRAFT_UPDATE_PROGRESS: 'APPLICATION_DRAFT_UPDATE_PROGRESS',
    APPLICATION_OUTBOX_SET_SENT: 'APPLICATION_OUTBOX_SET_SENT',
    APPLICATION_DRAFT_SET_SENT: 'APPLICATION_DRAFT_SET_SENT',
    APPLICATION_OUTBOX_SET_ERROR: 'APPLICATION_OUTBOX_SET_ERROR',
    APPLICATION_DRAFT_SET_ERROR: 'APPLICATION_DRAFT_SET_ERROR',
    APPLICATION_OUTBOX_MESSAGE_PROCESSED: 'APPLICATION_OUTBOX_MESSAGE_PROCESSED',
    APPLICATION_DRAFT_CLEAN: 'APPLICATION_DRAFT_CLEAN',
    ...
    FOLDERS_UPDATE_PARENT_ONLY: 'FOLDERS_UPDATE_PARENT_ONLY',
    ...
    MESSAGES_CLEAR_OPENED_AND_RECOVER_SELECTED: 'MESSAGES_CLEAR_OPENED_AND_RECOVER_SELECTED',
    ...
    LEXON_DATABASE: 'LEXON_DATABASE',
    LEXON_EMAIL: 'LEXON_EMAIL',
    LEXON_EMAIL_SET_SHOWN: 'LEXON_EMAIL_SET_SHOWN',
    LEXON_ACCOUNT: 'LEXON_ACCOUNT',
    LEXON_RESET_EMAIL: 'LEXON_RESET_EMAIL',
    ...
    LEXON_NEW_IDACTUATION: 'LEXON_NEW_IDACTUATION',
    LEXON_NEW_IDEVENT: 'LEXON_NEW_IDEVENT',
