export const ActionTypes = {
    ...
    LEXON_USER_NAME: 'LEXON_USER_NAME',
    LEXON_USER_AVAILABLE_SIGNATURES: 'LEXON_USER_AVAILABLE_SIGNATURES',
    LEXON_USER_BRANDINGS: 'LEXON_USER_BRANDINGS',
    LEXON_USER_APP: 'LEXON_USER_APP'
};