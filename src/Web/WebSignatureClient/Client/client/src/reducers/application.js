...
const application = (state = INITIAL_STATE.application, action = {}) => {
  switch (action.type) {
    ...
    case ActionTypes.APPLICATION_SIGNATURES_FILTER_SET:
      return {
        ...state,
        signaturesFilterKey: action.payload
      };
    ...
    case ActionTypes.APPLICATION_SIGNATURE_SELECT:
    ...
    case ActionTypes.APPLICATION_SIGNATURE_PRE_DOWNLOAD: {
      const newState = {...state};
      const signatures = action.payload.signatures;
      newState.signatures = signatures
      return newState;
    }

    case ActionTypes.APPLICATION_EMAILS_PRE_DOWNLOAD: {
      const newState = {...state};
