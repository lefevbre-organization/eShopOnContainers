...
export class Downloader extends React.Component {
    ...
    render() {
        ...
        return <div className="document-wrapper">
            <div className="document">
                ...
                <div className="document-info">
                    ...
                    <div className="document-size">{length ? prettyBytes(length) : "-"}</div>
                </div>
            </div>
            <div>
                <ProgressBar current={this.state.progress} error={this.state.error}>
                </ProgressBar>
            </div>
        </div>
    }
