...
namespace Lefebvre.eLefebvreOnContainers.Services.Lefebvre.eLefebvreOnContainers.Services.Google.Drive.API.API.Extensions
{
    public static class CustomExtensionsMethods
    {
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Lefebvre Now - Google Drive HTTP API",
                    Version = "v1",
                    Description = "The Google Drive Microservice HTTP API. This is a Data-Driven/CRUD microservice sample"
                });
