    ...
    public static class CustomExtensionsMethods
    {
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Lefebvre Now - Google Account HTTP API",
                    Version = "v1",
                    Description = "The Google Account Microservice HTTP API. This is a Data-Driven/CRUD microservice sample"
                });
                ...
                //            {
                //                { "googleaccount", "Google Account API" }
                //            }
                //        }
                //    }
                //});
