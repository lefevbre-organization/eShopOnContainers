using Lefebvre.eLefebvreOnContainers.Services.Google.Account.API.Infrastructure.ActionResults;
...
namespace Lefebvre.eLefebvreOnContainers.Services.Google.Account.API.Infrastructure.Filters
{
    public class HttpGlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (context.Exception.GetType() == typeof(GoogleAccountDomainException))
            {
