...
namespace Lefebvre.eLefebvreOnContainers.Services.Conference.API.Infrastructure
{
    //mirar https://www.mongodb.com/blog/post/working-with-mongodb-transactions-with-c-and-the-net-framework
    public class ConferenceContext : IMongoDbContext, IIntegrationEventLogContextMongoDB
    {
