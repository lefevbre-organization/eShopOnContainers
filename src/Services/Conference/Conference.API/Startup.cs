...
using Lefebvre.eLefebvreOnContainers.Services.Conference.API.Controllers;
using Lefebvre.eLefebvreOnContainers.Services.Conference.API.Extensions;
using Lefebvre.eLefebvreOnContainers.Services.Conference.API.Infrastructure.Filters;
...
namespace Lefebvre.eLefebvreOnContainers.Services.Conference.API
{
    public class Startup
    {
        ...
        public virtual IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            .AddApplicationPart(typeof(ConferenceController).Assembly)
            .AddNewtonsoftJson()
                ;
            ...
            services.Configure<ConferenceSettings>(Configuration);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger()
               .UseSwaggerUI(setup =>
               {
                   setup.SwaggerEndpoint($"{ (!string.IsNullOrEmpty(pathBase) ? pathBase : string.Empty) }/swagger/v1/swagger.json", "Conference.API V1");
                   setup.OAuthClientId("conferenceswaggerui");
                   setup.OAuthAppName("Conference Swagger UI");
               });
