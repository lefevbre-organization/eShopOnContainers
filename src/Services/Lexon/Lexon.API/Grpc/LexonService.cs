...
namespace GrpcLexon
{
    public class LexonService  //: Lexon.LexonBase
    {
        private readonly IUsersRepository _repository;
        private readonly ILogger<LexonService> _logger;

        public LexonService(IUsersRepository repository, ILogger<LexonService> logger)
        {
