...
using Lefebvre.eLefebvreOnContainers.Services.Lexon.MySql.Infrastructure.Filters;
using Lefebvre.eLefebvreOnContainers.Services.Lexon.MySql.Infrastructure.Middlewares;
    ...
    public class Startup
    {
        ...
        public virtual IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllers(options =>
                ...
                .AddApplicationPart(typeof(LexonMySqlController).Assembly)
                //.AddNewtonsoftJson()
                ;
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger()
               .UseSwaggerUI(setup =>
               {
                   setup.SwaggerEndpoint($"{ (!string.IsNullOrEmpty(pathBase) ? pathBase : string.Empty) }/swagger/v1/swagger.json", "Lexon.MySQL API V1");
                   setup.OAuthClientId("lexonmysqlswaggerui");
                   setup.OAuthAppName("Lexon MySQL Swagger UI");
               });
            ...
            {
                endpoints.MapGrpcService<LexonMySqlService>();
                endpoints.MapDefaultControllerRoute();
                endpoints.MapControllers();
                endpoints.MapGet("/_proto/", async ctx =>
                {
                    ctx.Response.ContentType = "text/plain";
                    using var fs = new FileStream(Path.Combine(env.ContentRootPath, "Proto", "lexonmysql.proto"), FileMode.Open, FileAccess.Read);
