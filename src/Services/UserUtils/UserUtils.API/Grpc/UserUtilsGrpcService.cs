...
namespace GrpcUserutils
{
    public class UserUtilsGrpcService : BaseClass<UserUtilsGrpcService> //, IUserUtilsService
    {
        ...
        {
            return await _svc.GetEncodeUserAsync(idNavisionUser);
        ...
        {
            return await _svc.GetDecodeUserAsync(idEncodeNavisionUser);
        ...
        {
            return await _svc.GetUserUtilsAsync(idNavisionUser, onlyActives);
        ...
        //async Task<List<LefebvreApp>> UpdateListByPass(string idNavisionUser, LefebvreApp[] resultado, List<ErrorInfo> errors, bool onlyActives)
        //{
        ...
        {
            return await _svc.GetUserDataWithLoginAsync(login, pass);
        ...
        {
            return await _svc.GetUserDataWithEntryAsync(idNavisionUser);
            //var result = new Result<ServiceComUser>(new ServiceComUser());
            //try
            //{
        ...
        {
            return await _svc.GetAreasByUserAsync(idNavisionUser);
        ...
        {
            return await _svc.GetUserUtilsActualToServiceAsync(idUser, nameService);
        ...
        {
            return await _svc.GetUserUtilsActualToSignatureAsync(idUser);
            //var result = new Result<string>(null);
            //var urlReplace = "";
            //try
            //{
        ...
        //async Task<Result<string>> GeUserUtilFinalLink(string newUrl)
        //{
        //    var result = new Result<string>(null);
        //    try
        //    {
        ...
        {
            return await _svc.VadidateTokenAsync(tokenRequest, validateCaducity);
        ...
        {
            return await _svc.GetGenericTokenAsync(tokenRequest, addTerminatorToToken);
        ...
        //async Task ManageTokenLexon(TokenRequest tokenRequest, Result<TokenData> result)
        //{
        //    var inicio = DateTime.Now;
        ...
        //async Task<Result<LexUserSimple>> GetLexonUserIdAsync(string idNavisionUser)
        //{
        ...
        {
            return await _svc.GetLexonGenericAsync(token, idApp, addTerminatorToToken);
        ...
        //async Task<TokenRequestNewMail> GetContactDataFromLexon(TokenRequestNewMail token, Result<TokenData> result)
        //{
        ...
        //void SerializeObjectToPost(object parameters, string path, out string url, out StringContent data)
        //{
        ...
        {
            return await _svc.FirmCheckAsync(idClient, numDocs);
        ...
        {
            return await _svc.FirmCheckAvailableAsync(idClient);
        ...
        {
            return await _svc.FirmUseAsync(idClient, idUser, numDocs);
            //var result = new Result<bool>(false);
