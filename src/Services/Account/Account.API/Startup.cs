...
using Lefebvre.eLefebvreOnContainers.Services.Account.API.Controllers;
using Lefebvre.eLefebvreOnContainers.Services.Account.API.Infrastructure.Filters;
using Lefebvre.eLefebvreOnContainers.Services.Account.API.Infrastructure.Middlewares;
using Lefebvre.eLefebvreOnContainers.Services.Account.API.Infrastructure.Repositories;
    ...
    public class Startup
    {
        ...
        public virtual IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllers(options =>
            {
                ...
                .AddApplicationPart(typeof(EmailUserAccountController).Assembly)
                .AddNewtonsoftJson();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGet("/_proto/", async ctx =>
                {
                    ...
                    using var fs = new FileStream(Path.Combine(env.ContentRootPath, "Proto", "account.proto"), FileMode.Open, FileAccess.Read);
