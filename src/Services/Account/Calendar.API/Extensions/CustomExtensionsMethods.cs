using Autofac;
using Lefebvre.eLefebvreOnContainers.Services.Calendar.API.Infrastructure.Middlewares;
...
namespace Lefebvre.eLefebvreOnContainers.Services.Calendar.API.Extensions
{
    public static class CustomExtensionsMethods
    {
        ...
        public static IServiceCollection AddCustomHealthCheck(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            hcBuilder
                ...
                .AddMongoDb(
                    ...
                    name: "calendar-mongodb-check",
                    tags: new string[] { "mongodb" })
                .AddRabbitMQ(
                    $"amqp://{configuration["EventBusConnection"]}",
                    name: "calendar-rabbitmqbus-check",
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Lefebvre Now - Calendar HTTP API",
                    Version = "v1",
                    Description = "The Calendar Microservice HTTP API. This is a Data-Driven/CRUD microservice sample"
                });
