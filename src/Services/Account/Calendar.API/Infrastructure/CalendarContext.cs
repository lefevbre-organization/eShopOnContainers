...
namespace Lefebvre.eLefebvreOnContainers.Services.Calendar.API.Infrastructure
{
    using Microsoft.Extensions.Configuration;
    using Model;

    //mirar https://www.mongodb.com/blog/post/working-with-mongodb-transactions-with-c-and-the-net-framework
    public class CalendarContext : IMongoDbContext, IIntegrationEventLogContextMongoDB
    {
        ...
        private readonly IOptions<CalendarSettings> _settings;
