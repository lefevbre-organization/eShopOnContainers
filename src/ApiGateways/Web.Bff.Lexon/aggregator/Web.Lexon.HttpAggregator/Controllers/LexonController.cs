...
namespace Lefebvre.eLefebvreOnContainers.Web.Lexon.HttpAggregator.Controllers
{
    ...
    public class LexonController : ControllerBase
    {
        ...
        public LexonController(ICatalogService catalogService, IBasketService basketService)
        {
