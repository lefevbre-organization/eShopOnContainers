Param(
    ...
    [parameter(Mandatory=$false)][string[]]$charts=("apigwlex", "lexon-api", "lexonmysql-api", "apigwacc", "account-api", "apigwcen", "centinela-api", "userutils-api" , "webgoogle", "webgraph", "weblexon", "webportal", "webimap", "webimapserver", "webstatus"),
