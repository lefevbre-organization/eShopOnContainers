...
$infras = ( "nosql-data")
$charts = ( "apigwlex", "lexon-api", "lexonmysql-api", "apigwacc", "account-api", "apigwsig", "signature-api", "webgoogle", "webgraph", "weblexon", "webportal", "webimap", "webimapserver", "websignature", "webstatus", "webaddonlexon")
