Param(
    ...
    [parameter(Mandatory=$false)][string[]]$servicesToPush=("webportalclient", "webgoogleclient", "webofficeclient", "weblexonclient", "webimapclient", "account.api", "lexon.api", "lexon.mysql.api", "centinela.api", "userutils.api", "ocelotapigw", "webstatuslef", "webaddonlexon"),
