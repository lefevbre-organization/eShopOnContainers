Param(
    ...
    # [parameter(Mandatory=$false)][string[]]$servicesToPush=("webportalclient", "webgoogleclient", "webofficeclient", "weblexonclient", "webimapclient", "account.api", "lexon.api","lexon.mysql.api", "ocelotapigw", "webstatuslef"),
    [parameter(Mandatory=$false)][string[]]$servicesToPush=("lexon.mysql.api","lexon.api"),
